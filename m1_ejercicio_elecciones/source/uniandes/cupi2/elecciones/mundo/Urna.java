...
public class Urna
{
    ...
    {
    	double numVotosInternetCandidato1;
    	double numTotalVotosInternet;
    	double porcentaje;
    	numVotosInternetCandidato1=candidato1.darVotosInfluenciaInternet();
    	numTotalVotosInternet = calcularTotalVotosInternet();
    	porcentaje = 100*(numVotosInternetCandidato1/numTotalVotosInternet);
    	return porcentaje;
    }
    ...
    {
    	double x = candidato2.darVotosInfluenciaInternet();
    	return(100*x/calcularTotalVotosInternet());
    }
